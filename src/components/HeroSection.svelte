	...
	<div class="hero-overlay">
		<div class="hero-content">
			...
			<div class="container-buttons">
				<a href={ctaLink1} class="mint-btn">
                    <span class="link-mint-btn">{cta1}</span>
                </a>
				<a href={ctaLink2} class="mint-btn">
                    <span class="link-mint-btn">{cta2}</span>
                </a>
			</div>
		</div>
	</div>
